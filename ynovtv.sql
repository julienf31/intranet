...
--
-- Host: localhost    Database: ynovtv
-- ------------------------------------------------------
...
INSERT INTO `config` VALUES (1,'version','1.0'),(2,'ville_meteo','Toulouse');
/*!40000 ALTER TABLE `config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `config_tv`
--
...
--
-- Dumping data for table `config_tv`
--

LOCK TABLES `config_tv` WRITE;
/*!40000 ALTER TABLE `config_tv` DISABLE KEYS */;
INSERT INTO `config_tv` VALUES ('bde','',5000),('news','logo_ynovcampus_couleur.png',8000);
/*!40000 ALTER TABLE `config_tv` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `etudiants` VALUES ('Lim\'Art ','B3 Lim','AGUILA','Déborah','04/11/1996'),('Ingesup ','M2','AL JAOUHARI','Imane','23/08/1991'),('Ingésup Bourse','B2','ALARCON','Loïc','02/11/1991'),('Ingesup ','M2','AMOROSO','Cloé','05/06/1994'),('Ingesup ','M2','ANTUNES','Florian','26/05/1994'),('Ingesup ','B2','BEJAUD','Sacha','06/09/1996'),('Ingesup ','B2','BELLARIVA','Bastien','13/04/1996'),('Ingesup ','B2','BONAL','Arthur','14/01/1997'),('Lim\'Art ','B2 Lim','BOULOGNE','Adrien','24/04/1992'),('Ingesup ','B2','BOURDIN','Alexia','05/01/1997'),('Ingesup ','M2','BRAMONTE','Kenny','15/09/1992'),('Lim\'Art ','B2 Lim','BRESILLON','Bastien','15/03/1996'),('Ingesup Bourse','B1Ing','BRUCKER','Brice','18/11/1995'),('Ingesup ','M2','BRUNET','Thomas','27/05/1993'),('Ingesup ','B3','CAILLARD','Alexandre','12/03/1992'),('Ingesup ','M1','CAMBARAT ','Julien','21/11/1994'),('Ingesup ','M1','CAMINADE','Adrien','19/05/1995'),('Lim\'Art ','B2 Lim','CARIOU','Maureen','13/11/1997'),('Ingesup ','M1','CASSIGNOL','Pierre','22/01/1995'),('Lim\'Art ','B3 Lim','CECILIE','Goran','19/01/1994'),('Ingesup ','M2','CHAMATI','ALexandre','11/04/1992'),('Ingesup ','B2','CHAN','Eric','13/01/1997'),('Ingesup ','M1','COLLARD','Pierre','06/03/1995'),('Ingesup ','M1','COUGET','Pierrick','01/02/1995'),('Ingesup ','M2','CUPILLARD','Gabriel','03/04/1992'),('Ingesup Bourse','B2','DANG','Pascal','15/02/1992'),('Ingesup ','B2','DANIEL','Arthur','12/01/1994'),('Ingesup ','M1','DARIUS','AXEL','14/04/1995'),('Lim\'Art ','B2 Lim','DEBORD','Marion','03/01/1992'),('Ingesup ','M2','DEBRIS','Pierre-Henri','03/02/1994'),('Ingesup ','M1','DECOMIS','Colin','02/02/1992'),('Ingesup ','B3','DELGLAT','Kévin','23/07/1995'),('Ingesup ','M2','DELON','Hermine','14/08/1992'),('Ingesup ','M1','DELRUE','François','18/02/1993'),('Ingesup ','M1','DENEUX','Benjamin','14/10/1995'),('Ingesup ','B2','DEQUEKER','Richard','07/02/1991'),('Ingesup ','M1','DERAIN','Paul','14/12/1995'),('Ingesup ','B3','DEUMIER','Stephan','28/05/1994'),('Ingesup ','B2','DUFOUR ','Victor','05/02/1995'),('Ingesup Bourse','B2','DUMONT','Eric','04/12/1991'),('Ingesup ','M2','DUPIRE','Joffrey','13/01/1993'),('Ingesup ','M2','FAHMI','Mehdi','13/04/1990'),('Ingesup ','B2','FEHRENBACH','Félix','06/09/1996'),('Ingesup ','B2','FERRAND','Pierre-Alexandre','16/12/1995'),('Lim\'Art ','B2 Lim','FIORENTINI','William','21/08/1997'),('Ingesup ','M1','FLEURY','Clément','12/04/1991'),('Ingesup ','M2','GASTON','Aurélien','02/04/1993'),('Lim\'Art ','B3 Lim','GAUZE','Alexandra','08/02/1992'),('Ingesup ','B2','GEORGE','Kévin','06/07/1990'),('Lim\'Art ','B3 Lim','GIMENEZ','Thibault','22/03/1995'),('Ingesup ','M1','GIORGIUTTI','Mathieu','12/06/1991'),('Ingesup ','M2','GIRARDET','Julien','07/09/1992'),('Ingesup ','M2','GLEIZES ','Axel','22/05/1992'),('Lim\'Art ','B2 Lim','GOBEL','Lisa','21/11/1996'),('Ingesup ','B2','GUERIN','Maxime','28/10/1995'),('Ingesup ','B2','HERVIEU','Damien','17/12/1997'),('Ingesup ','M2','HUET','Benjamin','28/10/1992'),('Lim\'Art ','B2 Lim','HUISSOUD','Clément','19/03/1990'),('Ingesup ','B3','HUO YUNG KAI ','Kévin','11/12/1992'),('Ingesup ','M1','HUON','Loïc','28/09/1994'),('Ingesup ','M2','JALLAN','Rémy','05/12/1994'),('Ingesup ','B2','JOUANJAN','Eliott','06/05/1994'),('Lim\'Art ','B3 Lim','JUBIN','Cyrille','12/09/1995'),('Ingesup ','M1','JURADO','Benoît','09/10/1994'),('Ingesup ','M1','KADEH','Ahmed','13/10/1995'),('Ingesup ','B3','LABLANCHE','Valentin','15/06/1996'),('Ingesup ','M1','LAURENS','Robin','24/01/1992'),('Ingesup ','B3','LAURENT','Médéric','23/04/1993'),('Ingesup ','M2','LAVAYRE','Robin','14/07/1992'),('Ingesup Bourse','B2','LEMMOUCHI','Selim','28/06/1993'),('Ingesup ','M1','LEPAPE','Alexandre','02/08/1993'),('Ingesup ','B3','LEVER','Erwan','07/02/1997'),('Ingesup ','M1','LEYGUE','Damien','03/04/1990'),('Ingesup ','B2','LITAMPHA','Jordan','14/02/1996'),('Ingesup Bourse','B2','LOGE','Florian','02/05/1996'),('Ingesup Bourse','B2','LOISEAU ','Thomas','17/06/1991'),('Lim\'Art ','B2 Lim','LONÉTÉ','Yvana','04/09/1996'),('Ingesup ','B3','LOZES','Clara','24/05/1994'),('Ingesup ','B3','LOZES','François','24/05/1994'),('Ingesup ','M1','MALFRAY','Pili','26/04/1995'),('Lim\'Art ','B2 Lim','MARCELIN-GABRIEL',' Cheyenne','30/08/1994'),('Ingesup ','M2','MARTINS','Noël','23/12/1989'),('Ingesup ','M2','MARTY','Alexandre','15/12/1992'),('Ingesup Bourse','B2','MAURE','Damien','23/01/1995'),('Ingesup ','M1','MEKKID','Amine','08/02/1995'),('Ingesup ','B3','MINETTO','Jordan','18/07/1994'),('Lim\'Art ','B3 Lim','MONGE','David','16/04/1994'),('Ingesup ','M1','MONTES','Cyril','01/10/1995'),('Ingesup ','M1','MURAT','Olivier','03/11/1992'),('Ingesup ','B2','NAUDY','Guillaume','22/10/1995'),('Ingesup ','B2','OUSSET','Pierre','13/12/1996'),('Ingesup ','M1','PASQUALON','Stéphanie','21/05/1987'),('Ingesup ','M1','PATTYN','Nicolas','05/05/1995'),('Lim\'Art ','B3 Lim','PAUTOT','Camille','01/12/1995'),('Ingesup ','B3','PELLE','Benjamin','19/06/1992'),('Ingesup ','B3','PEREZ','Maxime','25/12/1995'),('Ingesup ','M1','PEREZ','Benjamin','26/04/1991'),('Ingesup ','M1','PERRIER','Thomas','23/02/1994'),('Lim\'Art ','B3 Lim','PETITOT','Laurrie','22/06/1991'),('Ingesup ','M1','PINTO','Christophe','16/08/1993'),('Ingesup Bourse','B2','PLASSEAU','Gylian','26/04/1994'),('Ingesup Bourse','B2','PLOTEAU','Corentin','30/07/1993'),('Ingesup ','M1','POGACEAN','George Andrei','07/02/1987'),('Ingesup ','B2','PENDARIES','Florian','20/04/1995'),('Ingesup ','B2','POIROT','Gabriel','26/11/1995'),('Ingesup ','M2','PONSET','Johann','15/09/1994'),('Ingesup ','B3','PORTE','Antoine','16/12/1996'),('Ingesup ','M1','POULET','Maxime','25/05/1993'),('Ingesup ','B3','PRUDENT','Guilian','28/03/1996'),('Ingesup ','M1','RAHIER','Romain','13/05/1995'),('Ingesup ','B3','REY','Alexis','21/10/1996'),('Ingesup ','M2','REY','Paul','06/10/1994'),('Ingesup ','B3','ROUSSANGE','Alexandre','11/06/1996'),('Ingesup ','B2','POLATO','Jérôme','24/12/1994'),('Ingesup ','M2','RUBINI','Quentin','10/01/1994'),('Lim\'Art ','B2 Lim','SAINTVOIRIN','Léa','14/06/1996'),('Ingesup ','M2','SAISSI','Lucas','08/11/1991'),('Ingesup ','M1','SAN JOSE','Quentin','10/07/1995'),('Ingesup ','M2','SANTOS CABRITA','Alexandre','19/10/1989'),('Ingesup ','B3','SAULNERON','Rémi','21/02/1994'),('Ingesup ','M1','SEVERAC','Thibaut','14/03/1994'),('Ingesup ','M2','SICARD','Isabelle','10/12/1993'),('Ingesup ','M2','SŒUR','Rota','25/04/1990'),('Ingesup ','M2','SOTER','Thomas','10/08/1994'),('Ingesup ','B3','STEFANESCU','Valentin','17/03/1995'),('Ingesup ','B3','THIBAUDAT','Victor','18/06/1995'),('Ingesup ','M2','THOMELET','Jimmy','15/10/1993'),('Ingesup Bourse','B2','VAISSIERE','Nicolas','01/09/1993'),('Lim\'Art ','B2 Lim','VEAUTE','Eloïse','03/02/1996'),('Ingesup ','B1Ing','VARNIER','Tony','13/12/1997'),('Lim\'Art ','B2 Lim','VENITUS','Léonella-Rose hélène','09/10/1995'),('Ingesup ','B3','VIGNES','Julien','05/07/1995'),('Ingesup ','M1','VOIROL','Adrien','09/07/1995'),('Ingesup ','B2','ZAGULA','Léa','23/06/1997'),('Ingesup ','M2','RAYNIER ','Kévin','29/03/1993'),('Ingesup ','M2','MIMART','Arnaud','16/10/1993'),('Ingesup ','M2','MABROUK','Ons','27/01/1994'),('Ingesup','B1Ing','DI CRESCENZO','Alain','23/07/1998'),('Ingesup','B1Ing','CORNEAU','Fabio','12/08/1999'),('Ingesup','B3','GALIBERT','Thomas','20/07/1996'),('Ingesup','B1Ing','BERTAUD','Céline','24/12/1998'),('Lim\'Art ','MANAA','BERGES','Jean-Baptiste','09/03/1998'),('Ingesup','B1Ing','PICCININI','Thomas','13/02/1998'),('Ingesup','B3','BODEYO','Clovis','03/04/1995'),('Ingesup','B1Ing','TAURAND','Florian','04/11/1997'),('Ingesup','B1Ing','LE LAY','Logan','10/01/1997'),('Ingesup','B1Ing','HORTALA','Justine','21/05/1998'),('Lim\'Art ','MANAA','BERINGUIER','Elsa','23/06/1998'),('Lim\'Art ','MANAA','BERTHET','Marc','03/04/1995'),('Lim\'Art ','MANAA','BOURG','Fanny','18/07/1997'),('Ingesup Bourse','B1Ing','LE BIHAN','Thomas','10/09/1996'),('Ingesup','B1Ing','FOURNIER','Julien','12/08/1995'),('Ingesup','B1Ing','GASTON ','Antoine','01/10/1996'),('Lim\'Art ','MANAA','BUSCAIL','Thomas','29/03/1998'),('Ingesup Bourse','B1Ing','BEDAT','Joritz','06/11/1997'),('Ingesup','M1','AIT EL BACHA','Jawad','18/03/1992'),('Lim\'Art ','B3 Lim','CAMPI','Marie','05/03/1996'),('Lim\'Art ','MANAA','CHATEAU','Céline','11/11/1996'),('Ingesup','B1Ing','BRUN','Killian','17/06/1997'),('Ingesup','B1Ing','GACHE','Jules','07/07/1998'),('Ingesup','B1Ing','FERRAND','Félix','17/05/1999'),('Lim\'Art ','MANAA','CHRIQUI','Antoine','18/07/1994'),('Lim\'Art ','MANAA','CREACH','Viviane','24/03/1997'),('Ingesup','B3','BERNOU','Florian','01/05/1996'),('Ingesup','M1','BOUTRAND','Emeric','21/04/1993'),('Lim\'Art ','MANAA','DENIZOT','Baptiste','03/07/1997'),('Lim\'Art ','MANAA','DUCOMMUN','Thomas','12/12/1996'),('Lim\'Art ','MANAA','EUGONE','Grégory','03/09/1997'),('Lim\'Art ','MANAA','FAUCHER','Benajmin','01/05/1990'),('Ingesup','B1Ing','BANGOURA','Sékou','12/03/1996'),('Ingesup','B3','FAYE','Cheikh','06/03/1996'),('Lim\'Art ','MANAA','FAURÉ','Aurore','13/03/1998'),('Ingesup','M1','DURAND','Sébastien','19/06/1988'),('Lim\'Art ','MANAA','FRANCOISE','Zoe','17/09/1998'),('Lim\'Art ','MANAA','GARCIA','Fanny','28/12/1998'),('Ingesup','M1','BAGOUET','Alexandre','06/10/1989'),('Ingesup','B3','MOGLIA','Thomas','13/09/1995'),('Ingesup Bourse','B1Ing','GENISSEL','Benjamin','27/12/1996'),('ESSCA','B3','MANGA','Moubarak','18/09/1996'),('Lim\'Art ','MANAA','GUINARD','Gabin','17/12/1997'),('Ingesup','B3','BUET','Florian','10/05/1996'),('Ingesup','B1Ing','EDOUARD','Anthony','20/03/1997'),('ESSCA','B3','MASRAR','Aymane','04/09/1995'),('Lim\'Art ','MANAA','LE MINH TRIET','Lila','28/11/1994'),('Lim\'Art ','MANAA','LOGA','Louis','07/10/1996'),('Ingesup','B1Ing','CHAMPRIGAUD','Maëva','05/07/1996'),('Ingesup','M1','BERNIOLLES','Maxime','28/03/1991'),('Lim\'Art ','MANAA','LOUBIERES','Dorian','22/04/1996'),('Lim\'Art ','MANAA','MAILLOT','Maore','29/08/1998'),('Ingesup','M1','AMIRALI','Mohamed-Islem','21/08/1990'),('Lim\'Art ','MANAA','MARTIN','Claire','06/06/1989'),('Lim\'Art ','MANAA','MORTILLARO','Pierre','14/07/1996'),('Lim\'Art ','MANAA','MUSSART','Annalycia','30/05/1998'),('Lim\'Art ','MANAA','NOH','Daekyum','15/03/1991'),('Ingesup','B3','DAUTRICOURT','Jonathan','09/06/1988'),('Ingesup','B1Ing','FENOUL','Alexandre','24/02/1999'),('Lim\'Art ','B3 Lim','ESTEBAN','Margaux','26/04/1995'),('Lim\'Art ','MANAA','NUNES','Quentin','10/01/1998'),('ESSCA','B3','SANCHEZ','Nicolas','25/10/1995'),('Ingesup','B1Ing','MAILLARD',' Constance','28/10/1995'),('Ingesup','B3','TAMIAZZO','Frédéric','04/10/1995'),('Lim\'Art ','MANAA','RADOLA','Olivier','18/09/1996'),('Lim\'Art ','B2 Lim','KIRCHER','Lucie','26/06/1997'),('Lim\'Art ','MANAA','SEGOND','Adrien','27/08/1996'),('Ingesup','B1Ing','MARTINEZ','Mathieu','05/01/1995'),('Lim\'Art ','MANAA','TAGAA','Maliha','20/08/1998'),('Ingesup','B3','GABRIEL','Thomas','01/09/1995'),('Ingesup','M2','LAMBERT','David','11/07/1990'),('Lim\'Art ','MANAA','TENET','Benoït','03/11/1998'),('Ingesup','M2','DOURLENS','Thomas','25/09/1992'),('Ingesup','B3','REGLAT','Anicet','14/07/1993'),('ESSCA','B3','DUPIN','Charline','26/09/1996'),('Ingesup','M2','EVRARD','Quentin','22/10/1993'),('Ingesup','B1Ing','GRÉTOUCE','Thomas','03/07/1995'),('Ingesup','B1Ing','PAPPALLARDO','Antoine','25/06/1996'),('Ingesup','M1','SCHMITT','Hadrien','27/11/1988'),('Ingesup','M1','PRADEL','Florent','05/01/1991'),('Lim\'Art ','MANAA','THALAMY','Alexandre','30/05/1996'),('Lim\'Art ','MANAA','THOMAS','Lucas','09/11/1998'),('Ingesup','M1','FONTAS','Julien','12/01/1990'),('Ingesup','M1','LIGAS','Maxime','19/08/1994'),('Ingesup','B1Ing','ROSE','Timon','13/08/1995'),('Ingesup','B1Ing','FAYE','Pape','02/08/1996'),('Lim\'Art ','MANAA','TREACY','Maureen','30/03/1996'),('Ingesup','M1','GAUDIN','Alexis','02/10/1994'),('Ingesup','M1','BONNAFOUS','Mathieu','27/10/1995'),('Ingesup','B3','MARTIN','Pierre-Yves','24/08/1992'),('Lim\'Art ','MANAA','VARGAS','Arno','04/04/1997'),('ESSCA','B3','SAINT MARTIN TILLET','Sophie','23/10/1993'),('Ingesup','M2','MELKA','Anthony','25/01/1992'),('Lim\'Art ','MANAA','VERDIER','Clara','03/10/1997'),('Ingesup','B3','MARANSIN','Laurent','25/09/1996'),('Ingesup','B3','MICHEAU','Cédric','09/10/1992'),('Ingesup','B1Ing','MOKRI','Rayane','17/12/1995'),('Lim\'Art ','MANAA','VERNHES','Margaux','26/10/1989'),('Ingesup','B3','TAUZIN','Dominique','27/10/1992'),('Ingesup','B1Ing','BARATGIN','Léo ','07/09/1997'),('Ingesup','B1Ing','BISTI','Nicolas','09/12/1994'),('Lim\'Art ','MANAA','ZANETTE','Marion','04/12/1998'),('Ingesup','M2','LACARRERE','Nicolas','05/04/1990'),('Ingesup','B3','QUENTIN ','Alexandre','28/08/1995'),('Lim\'Art ','MANAA','BARON','Killian','14/09/1997'),('Ingesup','B2','OZOUAKI','Albert','11/09/1994'),('Ingesup','B2','COULIBALY','Makan','06/02/1994'),('Lim\'Art ','MANAA','MARCHIORO','Camille','02/08/1995'),('Lim\'Art ','MANAA','CAVALIER','Pablo','29/06/1997'),('Ingesup ','B1','DEMIR','Aurélie','19/10/1994'),('Ingesup ','B3','HILD','Franck','18/09/1992'),('Ingesup ','M1','BARSE','Thomas','04/11/1988'),('Ingesup ','M2','POYER','Florian','16/06/1993'),('Ingesup ','M2','DUYCK','Thibaud','18/06/1992'),('Ingesup ','B3','ANDRE','Jérôme','06/08/1993'),('Ingesup','B3','DESCARGUES','Vincent','06/02/1994'),('Ingesup','B1','PERON','Nicolas','08/06/1996'),('Ingesup','B3','PITAVAL','Dylan','18/07/1996'),('Ingesup','B1','FROMONT','Nathan','09/08/1994'),('Ingesup','B3','MANTES','Julien','18/06/01995'),('Ingesup ','B2','GRECO','Xavier','05/09/96'),('Lim\'Art ','MANAA','CAZEAUX','Clarisse','25/12/1997'),('ESSCA','B3','SALL','Mouhamadou','04/01/1996'),('Ingesup ','M1','LARAVINE','Thibaut','09/09/94'),('Ingesup ','M2','EXPERT','Adrien','28/08/90'),('Ingesup ','M2','CORDANI','Anthony','17/02/93'),('ESSCA','B3','D\'ALMEIDA','Ludiviane','10/08/1994'),('Ingesup','B3','DELAVELLE','Arnaud','18/05/1995'),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','',''),('','','','','');
...
INSERT INTO `intervenants` VALUES ('AOUDJA ','Thierry ','25/05/1960'),('BERNARD','Antoine','17/01/1991'),('BOUSSOT ','Estelle','27/06/1985'),('DONAIRE','Sylvie','28/08/1960'),('LAFAGE ','Fabien','12/10/1979'),('LEROY ','Emilie','09/08/1983'),('PETIT','JEAN-hugues','04/02/1959'),('ROALDES','R','27/01/1973'),('TREUFFET','Yann','16/05/1978'),('TUFFERY  ','Michel','13/06/1948'),('ROUX','Fabienne','06/01/1969'),('GRABIE','Alexis','02/01/1969'),('MEUNIER LACAY ','Jean- Maxime','30/11/1984'),('VIDAL',' Jean-Phillipe','17/12/1991'),('MAILLIET ','François-Hugues','31/03/1964'),('PENNEMAN','Philippe','23/03/1966'),(' RENUN ','Charlotte','14/06/1975'),('ACHI ','Nassim','03/07/1983'),('BOUREBABA','Reda',''),('CAPO','Jéremy','28/01/1987'),('PERRIN','Cédric','01/10/1975'),('MADSEN','Sarah','05/10/1969'),('DE MONTGLOFIER','Francois Xavier','27/08/1953'),('FORSTER','Sian','07/07/1986'),('ZAYOUNA ','Thomas','20/09/1984'),('PIAU','Rémy','14/10/1985'),('VENZ','Kelly','08/05/1981'),('DUHAILLIER','Caroline','03/03/1973'),('ROUSSEL ','Matthieu','05/02/1964'),('LI','Zhe','19/03/1985'),('FRANCOIS ','Cyrille','16/10/1972'),('PONCE','Laurence','06/06/1971'),('PROCHILO','Elvire','03/08/1971'),('GRIVEL','Marie-Françoise','20/05/1965'),('D\'ANDRIA','Jean-Marc','03/03/1971'),('OLLAGNIER','Ludovic','13/08/1986'),('LE PEZENNEC','Brigitte',''),('BARRALON','Alice','05/11/1979'),('DOAN ','Irene','10/01/1978'),('DURANTIN','Stéphanie','13/11/1973'),('BUSOLIN','Mathieu','11/09/1991');
...
INSERT INTO `news` VALUES (1,1,'titre',1,'root','Image_Parallels_4.png','','2017-01-11'),(2,1,'<small>edbwue</small>',1,'root','default/white.png','<p>&lt;iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/Dh2z0NJepJU\" frameborder=\"0\" allowfullscreen&gt;&lt;/iframe&gt;</p>','2017-01-12'),(3,1,'align right',1,'root','default/white.png','<p style=\"text-align: right;\">testouille</p>','2017-01-18');
/*!40000 ALTER TABLE `news` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `news_bde`
--
...
--
-- Dumping data for table `news_bde`
--

LOCK TABLES `news_bde` WRITE;
/*!40000 ALTER TABLE `news_bde` DISABLE KEYS */;
INSERT INTO `news_bde` VALUES (6,1,'POKER',NULL,'root','poker_tv.png','','2017-01-18','TEXT'),(7,1,'LAN',NULL,'Robin','','{\"type\":\"video\", \"plateform\":\"youtube\", \"videoId\":\"pnnJKvO9Ceg\"}','2017-01-18','JSON');
/*!40000 ALTER TABLE `news_bde` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (1,'root','30d69d863dde81562ce277fbc0a3cf18'),(2,'jonathan','78842815248300fa6ae79f7776a5080a'),(3,'admin','e098947e8d9b3e657c1c21808d1201ab'),(4,'bde','e016e1eeef801863e5af277e32ab99ae');
...
-- Dump completed on 2017-01-18 17:52:19
