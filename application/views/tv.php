...
<?php if($current_config['maintenance']): ?>
  <style>
    html,
    body {
  ...
  <h3 class="titrenews"><i class="fa fa-refresh fa-5x"></i></h3>
  <h3 class="titrenews" style="color: black;"><span class="oops">Ooops!</span><br />
Mise à jour en cours<br/><br/>
Le service sera rétabli sous peu....</h3>
  <script>
    function refresh() {
  ...
  <?php else: ?>
    ...
    <div id="news" class="container-fluid animated hidden">
      ...
      <?php if(isset($view)) :?>
        <!-- Si la news existe  -->
        <?php if($item_type == 'bde' && $view['afficher_titre'] =='1' && $view['text_type'] != 'JSON'): ?>
          <!-- Titre BDE -->
          <div class="row">
            <div class="col-sm-12">
          ...
          <?php elseif($item_type=='news') : ?>
            ...
            <?php endif; ?>
              <?php endif; ?>
                ...
                <?php if(!isset($view)): ?>
                  <!-- Si il n'y a pas de news a afficher -->
